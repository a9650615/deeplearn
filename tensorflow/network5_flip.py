...
def main_network(images, training):
    ...
    with pt.defaults_scope(activation_fn=tf.nn.relu, phase=phase):
        y_pred, loss = x_pretty.\
            conv2d(kernel=(32, 3), stride=2, depth=5, name='test_conv1', batch_normalize=True).\
            conv2d(kernel=5, stride=2, depth=32, name='layer_conv1', activation_fn=tf.nn.relu).\
            ...
            fully_connected(size=64, name='layer_fc1', activation_fn=None).\
